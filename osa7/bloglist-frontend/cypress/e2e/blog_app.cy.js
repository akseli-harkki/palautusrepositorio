  ...
  describe('when logged in', function () {
    ...
    describe('and a blog exists', function () {
      ...
      it('it can be liked', function () {
        cy.contains('a cool blog a cool blogger').contains('view').click()
        cy.get('#like-button').click()

        cy.contains('a cool blog a cool blogger').contains('likes 0')
      })
    ...
    describe('and multiple blogs exists', function () {
      ...
      it('they are ordered by likes', function () {
        ...
        cy.contains('least likes').contains('like').click()

        cy.contains('middle likes').contains('view').click()

        for (let i = 0; i < 3; i++) {
          cy.contains('middle likes').contains('like').click()
          cy.wait(100)
        }
